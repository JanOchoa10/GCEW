...
function loadAnimatedModelAndPlay0() {
  ...
  loader.load("Character1.fbx", (loadedfbx0) => {
    ...
    fbx0.position.copy(new THREE.Vector3(-80, 0, -30));
...
function loadAnimatedModelAndPlayWoman() {
  ...
  loader.load("Character2_P.fbx", (loadedfbx22) => {
    ...
    fbx1.position.copy(new THREE.Vector3(10, 0, 100));
...
function loadAnimatedModelAndPlayGrandmaOhShitDamn() {
  ...
  loader.load("Character4_P.fbx", (loadedfbx23) => {
    ...
    fbx3.position.copy(new THREE.Vector3(90, 0, 130));
...
function loadConstruction1() {
  ...
  loader.load("farm.fbx", (loadedfbx1) => {
    fbxConstruction = loadedfbx1;
    fbxConstruction.scale.setScalar(0.1);
    fbxConstruction.traverse((c) => {
      c.castShadow = true;
    });
    fbxConstruction.position.copy(new THREE.Vector3(100, 0, 100));
...
function loadConstruction2() {
  const loader = new FBXLoader();
  loader.setPath("../resources/farmModels/");
  loader.load("vetryak.fbx", (loadedfbx2) => {
    fbxConstruction2 = loadedfbx2;
    fbxConstruction2.scale.setScalar(0.1);
    fbxConstruction2.traverse((c) => {
      c.castShadow = true;
    });
    fbxConstruction2.position.copy(new THREE.Vector3(60, 0, 100));
    ...
    const animLoader = new FBXLoader();
    animLoader.setPath("../resources/farmModels/");
    animLoader.load("vetryak.fbx", (anim) => {
...
function loadConstruction4() {
  const loader = new FBXLoader();
  loader.setPath("../resources/buildings/");
  loader.load("church.fbx", (loadedfbx4) => {
    fbxConstruction4 = loadedfbx4;
    fbxConstruction4.scale.setScalar(0.1);
    fbxConstruction4.traverse((c) => {
      c.castShadow = true;
    });
    fbxConstruction4.position.copy(new THREE.Vector3(40, 0, -150));
    ...
    const animLoader = new FBXLoader();
    animLoader.setPath("../resources/buildings/");
    animLoader.load("church.fbx", (anim) => {
...
function loadConstruction6() {
  ...
  loader.load("gasoline.fbx", (loadedfbx6) => {
    ...
    fbxConstruction6.position.copy(new THREE.Vector3(-200, 0, 150));
...
function loadTrees1() {
  ...
  loader.load("tree2.fbx", (loadedfbx7) => {
    ...
    tree1.position.copy(new THREE.Vector3(40, 0, -10));

    // Crear la caja de colisión para el modelo animado
    BBtree1 = new THREE.Box3().setFromObject(tree1);
...
function loadTrees2() {
  ...
  loader.load("tree2.fbx", (loadedfbx7) => {
    ...
    tree2.position.copy(new THREE.Vector3(150, 0, 45));

    // Crear la caja de colisión para el modelo animado
    BBtree2 = new THREE.Box3().setFromObject(tree2);
...
function loadTrees3() {
  ...
  loader.load("tree2.fbx", (loadedfbx7) => {
    ...
    tree3.position.copy(new THREE.Vector3(-80, 0, -20));

    // Crear la caja de colisión para el modelo animado
    BBtree3 = new THREE.Box3().setFromObject(tree3);
...
function loadTrees4() {
  ...
  loader.load("tree2.fbx", (loadedfbx7) => {
    ...
    tree4.position.copy(new THREE.Vector3(150, 0, 45));

    // Crear la caja de colisión para el modelo animado
    BBtree4 = new THREE.Box3().setFromObject(tree4);
