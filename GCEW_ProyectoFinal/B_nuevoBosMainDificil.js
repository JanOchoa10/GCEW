...
const directionalLight = new THREE.DirectionalLight(0x92FCD6, 0.60);
...
// Crear la luz focal
var spotLight = new THREE.SpotLight(0xF7E53E);
...
function loadAnimatedModelAndPlay() {
  ...
  loader.load("Character1.fbx", (loadedfbx) => {
    ...
    fbx.position.copy(new THREE.Vector3(-127, 0, 0));
...
function loadAnimatedModelAndPlay0() {
  ...
  loader.load("Character1.fbx", (loadedfbx0) => {
    ...
    fbx0.position.copy(new THREE.Vector3(-60, 0, 95));
...
function loadAnimatedModelAndPlayWoman() {
  ...
  loader.load("Character2_P.fbx", (loadedfbx22) => {
    ...
    fbx1.position.copy(new THREE.Vector3(58, 0, 152));
...
function loadAnimatedModelAndPlayWoman2() {
  ...
  loader.load("Character2_P.fbx", (loadedfbx2) => {
    ...
    fbx2.position.copy(new THREE.Vector3(0, 0, -130));
...
function loadAnimatedModelAndPlayGrandmaOhShitDamn() {
  ...
  loader.load("Character4_P.fbx", (loadedfbx23) => {
    ...
    fbx3.position.copy(new THREE.Vector3(40, 0, 50));
...
function loadSkullPowerUp2() {
  ...
  loader.load("Gasoline_PowerUp1.fbx", (loadedfbx25) => {
    ...
    fbxPowerUp2.position.copy(new THREE.Vector3(125, 0, 35)); //Posición
...
function loadConstruction1() {
  ...
  loader.load("hotel.fbx", (loadedfbx1) => {
    ...
    fbxConstruction.position.copy(new THREE.Vector3(115, 0, 110));
...
function loadConstruction2() {
  ...
  loader.load("cabin1.fbx", (loadedfbx2) => {
    ...
    animLoader.load("cabin1.fbx", (anim) => {
...
function loadConstruction4() {
  const loader = new FBXLoader();
  loader.setPath("../resources/farmModels/");
  loader.load("cabin2.fbx", (loadedfbx4) => {
    fbxConstruction4 = loadedfbx4;
    fbxConstruction4.scale.setScalar(0.1);
    fbxConstruction4.traverse((c) => {
      c.castShadow = true;
    });
    fbxConstruction4.position.copy(new THREE.Vector3(-115, 0, 140));
    ...
    const animLoader = new FBXLoader();
    animLoader.setPath("../resources/farmModels/");
    animLoader.load("cabin2.fbx", (anim) => {
...
function loadConstruction5() {
  ...
  loader.load("tree3.fbx", (loadedfbx5) => {
    ...
    const animLoader = new FBXLoader();
    animLoader.setPath("../resources/farmModels/");
    animLoader.load("tree3.fbx", (anim) => {
...
function loadConstruction6() {
  ...
  loader.load("gasoline.fbx", (loadedfbx6) => {
    ...
    fbxConstruction6.position.copy(new THREE.Vector3(-250, 0, -120));
...
function loadConstruction7() {
  ...
  loader.load("tree1.fbx", (loadedfbx7) => {
    ...
    const animLoader = new FBXLoader();
    animLoader.setPath("../resources/farmModels/");
    animLoader.load("tree1.fbx", (anim) => {
...
function loadtrees1() {
  ...
  loader.load("tree1.fbx", (loadedfbx7) => {
    tree1 = loadedfbx7;
    tree1.scale.setScalar(0.1);
    tree1.traverse((c) => {
      c.castShadow = true;
    });
    tree1.position.copy(new THREE.Vector3(65, 0, 10));

    // Crear la caja de colisión para el modelo animado
    modeltree1 = new THREE.Box3().setFromObject(tree1);

    const animLoader = new FBXLoader();
    animLoader.setPath("../resources/farmModels/");
    animLoader.load("tree1.fbx", (anim) => {
      const mixer = new THREE.AnimationMixer(tree1);
      animationMixer.push(mixer);
      const idleAction = mixer.clipAction(anim.animations[0]);
      idleAction.play();
...
function loadtrees2() {
  ...
  loader.load("tree1.fbx", (loadedfbx7) => {
    ...
    // Crear la caja de colisión para el modelo animado
    modeltree2 = new THREE.Box3().setFromObject(tree2);

    const animLoader = new FBXLoader();
    animLoader.setPath("../resources/farmModels/");
    animLoader.load("tree1.fbx", (anim) => {
      const mixer = new THREE.AnimationMixer(tree2);
      animationMixer.push(mixer);
      const idleAction = mixer.clipAction(anim.animations[0]);
      idleAction.play();
...
function loadtrees3() {
  ...
  loader.load("tree1.fbx", (loadedfbx7) => {
    tree3 = loadedfbx7;
    tree3.scale.setScalar(0.1);
    tree3.traverse((c) => {
      c.castShadow = true;
    });
    tree1.position.copy(new THREE.Vector3(135, 0, -10));

    // Crear la caja de colisión para el modelo animado
    modeltree3 = new THREE.Box3().setFromObject(tree3);

    const animLoader = new FBXLoader();
    animLoader.setPath("../resources/farmModels/");
    animLoader.load("tree1.fbx", (anim) => {
      const mixer = new THREE.AnimationMixer(tree3);
      animationMixer.push(mixer);
      const idleAction = mixer.clipAction(anim.animations[0]);
      idleAction.play();
...
function loadtrees4() {
  ...
  loader.load("tree1.fbx", (loadedfbx7) => {
    tree4 = loadedfbx7;
    tree4.scale.setScalar(0.1);
    tree4.traverse((c) => {
      c.castShadow = true;
    });
    tree4.position.copy(new THREE.Vector3(-155, 0, -10));

    // Crear la caja de colisión para el modelo animado
    modeltree4 = new THREE.Box3().setFromObject(tree4);

    const animLoader = new FBXLoader();
    animLoader.setPath("../resources/farmModels/");
    animLoader.load("tree1.fbx", (anim) => {
      const mixer = new THREE.AnimationMixer(tree4);
      animationMixer.push(mixer);
      const idleAction = mixer.clipAction(anim.animations[0]);
      idleAction.play();
...
function loadtrees5() {
  const loader = new FBXLoader();
  loader.setPath("../resources/farmModels/");
  loader.load("tree3.fbx", (loadedfbx7) => {
    tree5 = loadedfbx7;
    tree5.scale.setScalar(0.1);
    tree5.traverse((c) => {
      c.castShadow = true;
    });
    tree5.position.copy(new THREE.Vector3(135, 0, -90));

    // Crear la caja de colisión para el modelo animado
    modeltree5 = new THREE.Box3().setFromObject(tree5);
...
function loadtrees6() {
  ...
  loader.load("tree3.fbx", (loadedfbx7) => {
    tree6 = loadedfbx7;
    tree6.scale.setScalar(0.1);
    tree6.traverse((c) => {
      c.castShadow = true;
    });
    tree6.position.copy(new THREE.Vector3(15, 0, -140));

    // Crear la caja de colisión para el modelo animado
    modeltree6 = new THREE.Box3().setFromObject(tree6);

    const animLoader = new FBXLoader();
    animLoader.setPath("../resources/farmModels/");
    animLoader.load("tree3.fbx", (anim) => {
      const mixer = new THREE.AnimationMixer(tree6);
      animationMixer.push(mixer);
      const idleAction = mixer.clipAction(anim.animations[0]);
      idleAction.play();
