...
import * as THREE2 from "https://cdn.jsdelivr.net/npm/three@0.118/build/three.module.js";
...
const planktonGeometry = new THREE.CapsuleGeometry(0.1, 0.5, 4, 8);
const planktonMaterial = new THREE.MeshPhongMaterial({ color: "green" });
const plankton = new THREE.Mesh(planktonGeometry, planktonMaterial);
plankton.position.set(-15, -0.5, 0);

const planktonBB = new THREE.Box3();
console.log(planktonBB);
planktonBB.setFromObject(plankton);

const sandyGeometry = new THREE.CapsuleGeometry(0.75, 1, 4, 8);
const sandyMaterial = new THREE.MeshPhongMaterial({
  color: "white",
  transparent: true,
});
const sandy = new THREE.Mesh(sandyGeometry, sandyMaterial);
sandy.position.set(12, 0, 0);

const sandyBB = new THREE.Box3();
console.log(sandyBB);
